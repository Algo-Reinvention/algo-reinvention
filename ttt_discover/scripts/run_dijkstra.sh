#!/bin/bash
# =================================================================
# TTT-Discover: Run Dijkstra algorithm reinvention
#
...
#
# Usage:
#   bash algo_test/ttt_discover/scripts/run_dijkstra.sh
#
# Override any config value via environment variables:
#   MODEL_PATH=/path/to/model bash algo_test/ttt_discover/scripts/run_dijkstra.sh
# =================================================================
...
CONFIG_PATH="${CONFIG_PATH:-$ALGO_TEST_ROOT/ttt_discover/configs/dijkstra.yaml}"
...
echo "============================================"
echo "  TTT-Discover: Dijkstra Reinvention"
echo "============================================"
