#!/bin/bash
# =================================================================
# TTT-Discover: Run Manacher's algorithm reinvention (Level 1)
#
# Usage:
#   bash algo_test/ttt_discover/scripts/run_manacher.sh
#
# Override any config value via environment variables:
#   MODEL_PATH=/path/to/model bash algo_test/ttt_discover/scripts/run_manacher.sh
# =================================================================
...
CONFIG_PATH="${CONFIG_PATH:-$ALGO_TEST_ROOT/ttt_discover/configs/manacher.yaml}"
...
echo "============================================"
echo "  TTT-Discover: Manacher Reinvention (L1)"
echo "============================================"
