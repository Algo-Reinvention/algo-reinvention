#!/bin/bash
# =================================================================
# TTT-Discover: Run Prim's MST algorithm reinvention (Level 1)
#
# Usage:
#   bash algo_test/ttt_discover/scripts/run_prim.sh
#
# Override any config value via environment variables:
#   MODEL_PATH=/path/to/model bash algo_test/ttt_discover/scripts/run_prim.sh
# =================================================================
...
CONFIG_PATH="${CONFIG_PATH:-$ALGO_TEST_ROOT/ttt_discover/configs/prim.yaml}"
...
echo "============================================"
echo "  TTT-Discover: Prim MST Reinvention (L1)"
echo "============================================"
