#!/bin/bash
# =================================================================
# TTT-Discover: Run array_moore algorithm reinvention
#
...
#
# Usage:
#   bash algo_test/ttt_discover/scripts/run_array_moore.sh
#
# Override any config value via environment variables:
#   MODEL_PATH=/path/to/model bash algo_test/ttt_discover/scripts/run_array_moore.sh
# =================================================================
...
CONFIG_PATH="${CONFIG_PATH:-$ALGO_TEST_ROOT/ttt_discover/configs/array_moore.yaml}"
...
echo "============================================"
echo "  TTT-Discover: array_moore Reinvention"
echo "============================================"
