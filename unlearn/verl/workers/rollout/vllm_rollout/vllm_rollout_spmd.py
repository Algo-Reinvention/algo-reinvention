...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        # NOTE @jzhao: no use if we have raw_prompt_ids; we tend to get (np.array)prompt_ids without padding
        ...
        # NOTE @jzhao: (not sure) seems support one model with multi lora parameters (for flexible change)
        lora_requests = None
        if self.lora_kwargs:
        ...
        with self.update_sampling_params(**kwargs):
            ...
            # NOTE @jzhao: default right padding
