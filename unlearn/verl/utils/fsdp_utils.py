...
def get_fsdp_wrap_policy(module, config=None, is_lora=False):
    ...
    #@jzhao
    # print(f"=====================================The model name is:{module.__class__.__name__}==========================================")
    if not fsdp_transformer_layer_cls_to_wrap:
        model_name = module.__class__.__name__
        if "mistral3" in model_name.lower():
            print(f"[FSDP Fix] Forcing wrap policy for {model_name}. Layers: Ministral3DecoderLayer, PixtralAttentionLayer")
...
def apply_fsdp2(model, fsdp_kwargs, config):
    ...
    #@jzhao
    # print(f"=====================================The model name is:{module.__class__.__name__}==========================================")
    if len(fsdp_transformer_layer_cls_to_wrap) == 0:
        ...
        fsdp_transformer_layer_cls_to_wrap = [Ministral3DecoderLayer, PixtralAttentionLayer]
    #/@jzhao
