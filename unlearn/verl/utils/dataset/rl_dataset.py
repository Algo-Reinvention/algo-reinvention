...
def collate_fn(data_list: list[dict]) -> dict:
    ...
    # NOTE @jzhao: convert to batch_size
...
class RLHFDataset(Dataset):
    ...
    def maybe_filter_out_long_prompts(self, dataframe: datasets.Dataset = None):
        ...
        if self.filter_overlong_prompts:
            ...
            if processor is not None:
                ...
                def doc2len(doc) -> int:
                    # return len(tokenizer(dataframe[prompt_key][0]['content']))
                    return len(tokenizer.encode(doc[prompt_key][0]['content'], add_special_tokens=False))
    ...
    def __getitem__(self, item):
        ...
        if self.processor is not None:
            ...
            model_inputs = self.processor(text=[raw_prompt], images=images, videos=videos, return_tensors="pt", add_special_tokens=False)
